...
#define VAR_STR_LINE(x) '\t' << #x << '=' << x << '\n'
	...
	inline std::ostream& operator<<(std::ostream& s, const SensorData& sensorData) {
		...
		s << VAR_STR_LINE(sensorData.m_colorCompressionType); ///////// YEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE
		s << VAR_STR_LINE(sensorData.m_depthCompressionType); ///////// YEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE
