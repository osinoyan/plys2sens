...
#define M_SENSOR_DATA_VERSION 4
		...
		void initDefault(
			...
			COMPRESSION_TYPE_COLOR colorType = TYPE_RAW,
			// COMPRESSION_TYPE_COLOR colorType = TYPE_JPEG,
			COMPRESSION_TYPE_DEPTH depthType = TYPE_RAW_USHORT,
			// COMPRESSION_TYPE_DEPTH depthType = TYPE_ZLIB_USHORT,
		...
		void loadFromFile(const std::string& filename) {
			...
			std::cout << "[m_versionNumber] " << m_versionNumber << "\n"; // ***********************
			...
			std::cout << "[m_sensorName] " << m_sensorName << "\n"; // ***********************
			...
			std::cout << "[m_colorCompressionType] " << m_colorCompressionType << "\n"; // ***********************
			std::cout << "[m_depthCompressionType] " << m_depthCompressionType << "\n"; // ***********************
			std::cout << "[m_colorWidth] " << m_colorWidth << "\n"; // ***********************
			std::cout << "[m_colorHeight] " << m_colorHeight << "\n"; // ***********************
			std::cout << "[m_depthWidth] " << m_depthWidth << "\n"; // ***********************
			std::cout << "[m_depthHeight] " << m_depthHeight << "\n"; // ***********************
			std::cout << "[m_depthShift] " << m_depthShift << "\n"; // ***********************
			...
			std::cout << "[numIMUFrames] " << numIMUFrames << "\n"; // ***********************
			exit(0); // ***************************
